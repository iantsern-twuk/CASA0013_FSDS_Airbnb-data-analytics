...
reviews = 'https://orca.casa.ucl.ac.uk/~jreades/data/20240614-London-listings.csv.gz'
...
listings_2021_path = cache_data(url_listings_2021, "2021_listings.csv.gz")
listings_2022_path = cache_data(url_listings_2022, "2022_listings.csv.gz")
listings_2023_path = cache_data(url_listings_2023, "2023_listings.csv.gz")
listings_2024_path = cache_data(url_listings_2024, "listings.csv.gz")
...
JESS REMEMBER TO TEST CODE OUTPUTS WITH NEW DAta source
