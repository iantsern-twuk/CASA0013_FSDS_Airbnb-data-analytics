...
listings_2021_path = cache_data(cleaned_2021, "2021_listings_clean.csv")
listings_2022_path = cache_data(cleaned_2022, "2022_listings_clean.csv")
listings_2023_path = cache_data(cleaned_2023, "2023_listings_clean.csv")
listings_2024_path = cache_data(cleaned_2024, "2024_listings_clean.csv")

listings_2021 = pd.read_csv(listings_2021_path)
listings_2022 = pd.read_csv(listings_2022_path)
listings_2023 = pd.read_csv(listings_2023_path)
listings_2024 = pd.read_csv(listings_2024_path)
