...
```{python}
warnings.filterwarnings("ignore", message="PROJ: proj_create_from_database: Cannot find proj.db")
...
Written in Markdown and generated from [Quarto](https://quarto.org/). Fonts used: [Liberation Serif](https://fonts.adobe.com/fonts/liberation-serif) (mainfont), [Liberation Sans](https://fonts.adobe.com/fonts/liberation-sans) (<span style="font-family:Sans-Serif;">sansfont</span>) and [Liberation Mono](https://fonts.google.com/specimen/Liberation-Mono) (`monofont`). 
